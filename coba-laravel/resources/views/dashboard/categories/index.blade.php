...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Ketegori Postingan</h1>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="/dashboard/categories/{{ $category->slug }}" method="post" class="d-inline">
                          ...
                          <button class="badge bg-danger border-0" onclick="return confirm('Yakin ingin menghapus data ?')"><span data-feather="x-circle" class="align-text-bottom"></span></button>
